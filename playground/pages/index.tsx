...
function Main({transpile}: {transpile: ReturnType<typeof genTranspile>}) {
    ...
    return (
        <div className="flex flex-col w-full h-screen">
            <header className="bg-[#222] text-white flex h-[55px] justify-between items-center pl-8 pr-8">
                <h2 className="text-xl">Typescript runtime checks</h2>
            ...
            <footer className="bg-[#222] text-white flex h-[55px] justify-center items-center w-full z-10">
                <p>
