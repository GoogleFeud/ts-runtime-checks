...
describe("Range", () => { describe("Assert", () => { describe("In function parameters", () => {
    function test(a) { if (typeof a !== "number" || (a < 1 || a > 5))
        throw new Error("Expected a to be Range<1, 5>."); return a; }
    it("Throw when the number is outside of the range", () => { (0, chai_1.expect)((0, utils_1.call)(test, 12)).to.throw("Expected a to be Range<1, 5>."); });
    it("Not throw when the number is in range", () => { (0, chai_1.expect)((0, utils_1.call)(test, 3)).to.not.throw(); });
