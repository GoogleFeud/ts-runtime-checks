    ...
    describe("Str<{matches}>", () => {
        function test(a) {
            if (typeof a !== "string" || !/foo*/g.test(a))
                throw new Error("Expected a to be a string and to match /foo*/g.");
            return a;
        }
        it("Throw when the regex doesn't match", () => {
            (0, chai_1.expect)((0, utils_1.call)(test, "hello")).to.throw("Expected a to be a string and to match /foo*/g.");
        });
        ...
        it("Throw when the provided value is not string", () => {
            (0, chai_1.expect)((0, utils_1.call)(test, 12)).to.throw("Expected a to be a string and to match /foo*/g.");
            (0, chai_1.expect)((0, utils_1.call)(test)).to.throw("Expected a to be a string and to match /foo*/g.");
        });
        function test2(a) {
            if (typeof a !== "string")
    ...
    describe("Str<{length}>", () => {
        function test(a) {
            if (typeof a !== "string" || a.length !== 32)
                throw new Error("Expected a to be a string and to have a length of 32.");
            return a;
        }
        it("Throw when the length doesn't match", () => {
            (0, chai_1.expect)((0, utils_1.call)(test, "hello")).to.throw("Expected a to be a string and to have a length of 32.");
        });
        it("Not throw when the regex matches", () => {
    ...
    describe("Str<{matches, length}>", () => {
        function test(a) {
            if (typeof a !== "string" || a.length !== 12 || !/foo*/g.test(a))
                throw new Error("Expected a to be a string, to have a length of 12 and to match /foo*/g.");
            return a;
        }
        it("Throw when the length doesn't match", () => {
            (0, chai_1.expect)((0, utils_1.call)(test, "foofoo")).to.throw("Expected a to be a string, to have a length of 12 and to match /foo*/g.");
        });
        it("Not throw when the regex matches", () => {
