    ...
    describe("Assert", () => {
            ...
            if (typeof a !== "string" && typeof a !== "number")
                if (!Array.isArray(a))
                    ...
                    if (typeof a[0] !== "string" && typeof a[0] !== "number")
                        throw new Error("Expected a[0] to be string | number");
                }
            return a;
        }
        ...
        function test1(a) {
            if (typeof a !== "object" || a === null)
                throw new Error("Expected a to be AMember | BMember | CMember");
            else {
                if (a.kind !== 2)
                    if (a.kind !== 1)
                        if (a.kind !== 0)
        ...
        it("Discriminated union: Throw when a different type is provided", () => {
            ...
            (0, chai_1.expect)((0, utils_1.call)(test1, {})).to.throw("Expected a to be AMember | BMember | CMember");
        });
        ...
        function test2(a) {
            if (typeof a !== "string")
                if (!Array.isArray(a))
                    if (typeof a !== "object" || a === null)
                        throw new Error("Expected a to be string | AMember | BMember | array<AMember | BMember>");
                    else {
                        if (a.kind !== 1)
                            if (a.kind !== 0)
                                throw new Error("Expected a to be string | AMember | BMember | array<AMember | BMember>");
                    ...
                    for (let i_1 = 0; i_1 < a.length; i_1++) {
                        if (typeof a[i_1] !== "object" || a[i_1] === null)
                            throw new Error("Expected a[" + i_1 + "] to be AMember | BMember");
                        else {
                            if (a[i_1].kind !== 1)
                                if (a[i_1].kind !== 0)
                                    throw new Error("Expected a[" + i_1 + "] to be AMember | BMember");
        ...
        it("Complex union: Throw when a different type is provided", () => {
            ...
            (0, chai_1.expect)((0, utils_1.call)(test2, { kind: 2, value: true })).to.throw("Expected a to be string | AMember | BMember | array<AMember | BMember>");
            (0, chai_1.expect)((0, utils_1.call)(test2, [123])).to.throw("Expected a[0] to be AMember | BMember");
        });
