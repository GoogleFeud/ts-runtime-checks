    ...
    describe("Assert", () => {
        function test(a) {
            if (typeof a !== "string" || !/foo*/g.test(a))
                throw new Error("Expected a to match \"/foo*/g\".");
            return a;
        }
        it("Throw when the regex doesn't match", () => {
            (0, chai_1.expect)((0, utils_1.call)(test, "hello")).to.throw("Expected a to match \"/foo*/g\".");
        });
        ...
        it("Throw when the provided value is not string", () => {
            (0, chai_1.expect)((0, utils_1.call)(test, 12)).to.throw("Expected a to match \"/foo*/g\".");
            (0, chai_1.expect)((0, utils_1.call)(test)).to.throw("Expected a to match \"/foo*/g\".");
        });
        function test2(a) {
            if (typeof a !== "string")
        ...
        it("Check only if the parameter is a string, if regex is not provided", () => {
            ...
            (0, chai_1.expect)((0, utils_1.call)(test2, 123)).to.throw("Expected a to be string.");
        });
    });
});
