        ...
        describe("In function parameters", () => {
            function test(a) {
                if (typeof a !== "string" || !/foo*/g.test(a))
                    throw new Error("Expected a to be Matches<\"/foo*/g\">.");
                return a;
            }
            it("Throw when the regex doesn't match", () => {
                (0, chai_1.expect)((0, utils_1.call)(test, "hello")).to.throw("Expected a to be Matches<\"/foo*/g\">.");
            });
            ...
            function test2(a) {
                if (typeof a !== "string")
                    throw new Error("Expected a to be Matches<string>.");
                return a;
            }
