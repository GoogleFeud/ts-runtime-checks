...
describe("Matches", function () { describe("Assert", function () { describe("In function parameters", function () {
    ...
    it("Not throw when the regex matches", function () { (0, chai_1.expect)((0, utils_1.call)(test, "soccer is not football")).to.not.throw(); });
    it("Throw when the provided value is not string", function () {
    ...
    it("Check only if the parameter is a string, if regex is not provided", function () {
