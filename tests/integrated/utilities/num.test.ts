...
describe("Num", () => {
    describe("Num{min, max}", () => {
        ...
        it("Throw when the number is outside of the range", () => {
            expect(call(test, 12)).to.throw("Expected a to be a number, to be greater than 1, to be less than 5");
        });
        ...
        it("Throw when the provided value is not a number", () => {
            expect(call(test, "abc")).to.throw("Expected a to be a number, to be greater than 1, to be less than 5");
            expect(call(test)).to.throw("Expected a to be a number, to be greater than 1, to be less than 5");
        });
        ...
        it("Not throw when only a max is specified", () => {
            ...
            expect(call(test2, 123)).to.throw("Expected a to be a number, to be less than 30");
        });
        ...
        it("Not throw when only a min is specified", () => {
            ...
            expect(call(test3, -44)).to.throw("Expected a to be a number, to be greater than -30");
        });
